...
LANGUAGE = "english"
SENTENCES_COUNT = 1
# add your local path for input file.csv
__inputFile = "/Users/venkatapagadala/Desktop/test.csv"
# urlinput = os.path.join(os.path.dirname(__file__), input('Enter input text file: '))
urls = open(__inputFile, "r")

# add your local path for Output file.csv
outputcsv = "/Users/venkatapagadala/Desktop/result.csv"
